...
(function ($) {
    ...
    var MagicSuggest = function (element, options) {
        ...
        /**
         * Add invalid class to ms
         * @param className - (optional) default to is-invalid
         */
        this.makeInvalid = function (className = 'is-invalid') {
            ms.container.addClass(className);
        };
         ...
         * @param className - (optional) default to is-invalid
         */
        this.makeValid = function (className = 'is-invalid') {
            ms.container.removeClass(className);
        };
        ...
        var self = {
            ...
            _renderSelection: function () {
                ...
                if (cfg.selectionPosition === 'inner' && !cfg.selectionContainer) {
                    ...
                    w = ms.container.width() - inputOffset - (42+37);
                    ms.input.width(w);
                }
